...
class ElecteurController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validator = Validator::make($input, ['numero_cin' => 'required','numero_electeur' => 'required','region' => 'required','departement' => 'required','commune' => 'required','prenom' => 'required','nom' => 'required','date_expiration' => 'required','numero_electeur_responsable' => 'required']);
